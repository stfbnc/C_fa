...
void dcca(double *ts1, int N1, double *ts2, int N2, int smallest_win_size, int biggest_win_num, int pol_ord, char *path_out, int rank, int size){
    ...
    double *F_proc;
    F_proc = malloc(F_proc_size * sizeof(double));
    ...
    if(rank == 0){
        ...
        F_rmnd_DCCA = malloc(F_proc_size * sizeof(double));
        F_rmnd_DFA_x = malloc(F_proc_size * sizeof(double));
        F_rmnd_DFA_y = malloc(F_proc_size * sizeof(double));
